...
/*
 * DELIMITER $$ 
 * CREATE PROCEDURE spInsert(Ename VARCHAR(10),Ecity VARCHAR(10),Emobileno INT,Ecollege VARCHAR(10))
 *  BEGIN 
 *  INSERT INTO dbase (NAME,city,mobileno,college) VALUES (Ename,Ecity,Emobileno,Ecollege); 
 *  END $$
 * 
